...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEucosLogo = (ImageView) findViewById(R.id.eucos_logo);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (UpdateService.STATE_ERROR_DISK_SPACE.equals(state)) {
                ...
                extraText = getString(R.string.error_disk_space_sub, current,
                        total);
                DrawableCompat.setTint(mEucosLogo.getDrawable(), ContextCompat.getColor(context, R.color.logo_err));
                ...
                DrawableCompat.setTint(mEucosLogo.getDrawable(), ContextCompat.getColor(context, R.color.logo_disabled));
            } else if (UpdateService.STATE_ERROR_DOWNLOAD.equals(state)) {
                enableCheck = true;
                progress.setIndeterminate(false);
                extraText = intent.getStringExtra(UpdateService.EXTRA_FILENAME);
                DrawableCompat.setTint(mEucosLogo.getDrawable(), ContextCompat.getColor(context, R.color.logo_alert));
                ...
                DrawableCompat.setTint(mEucosLogo.getDrawable(), ContextCompat.getColor(context, R.color.logo_green));
